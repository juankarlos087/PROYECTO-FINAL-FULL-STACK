<?php 
    ...
    $estud_id = $estud_identificacion = $estud_nombres = $estud_apellidos = $estud_email = $estud_telefono = $estud_direccion = $estud_genero = $estud_rh = "";
                        ...
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="genero" name="genero" value="<?= $estud_genero ?>" required>
                            </div>

                             <div class="form-group">
                                <label for="rh">Rh</label>
                                <input type="text" class="form-control" id="rh" name="rh" value="<?= $estud_rh?>" required>
                            </div>
